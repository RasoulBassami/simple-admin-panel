@component('admin.layout.content', ['title' => 'ایجاد کاربر جدید'])
            ...
            <form class="form-horizontal" method="post" action="{{ route('admin.users.store')}}" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="name" class="form-control" id="inputName" placeholder="نام و نام خانوادگی کاربر را وارد کنید">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="username" class="form-control" id="inputUserName" placeholder="نام کاربری کاربر را وارد کنید">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="password" name="password" class="form-control" id="inputPassword" placeholder="پسورد را وارد کنید">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group mt-2">
                        <label><strong>دسترسی های ادمین</strong></label><br>
